...
assert(p.availableCapital < 100000, 'Test 1b: capital deducted after buy');
assert(p.availableCapital === 100000 - (22022 * 10), 'Test 1c: exact capital deduction, expected: ' + (100000 - 22022 * 10) + ', got: ' + p.availableCapital);
...
assert(pnl.capital === 100000, 'Test 3d: capital = initialCapital');
